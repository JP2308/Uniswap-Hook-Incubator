...
contract InternalSwapPool is Test, Deployers {
    ...
    function setUp() public {
        ...
        deployCodeTo("InternalSwapPool.sol", abi.encode(manager), hookAddress);
    ...
    function test_swap_exactInput_zeroForOne() public {
        ...
        assertEq(balanceOfTokenBAfter - balanceOfTokenBBefore, 97e18);
    ...
    function test_swap_exactOutput_zeroForOne() public {
        ...
        assertEq(balanceOfTokenABefore - balanceOfTokenAAfter, 103e18);
    }
}